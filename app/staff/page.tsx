        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-white/20 backdrop-blur-sm rounded-full mb-4 md:mb-6">
              <span className="text-xs md:text-sm font-semibold uppercase tracking-wider">Nuestros Profesionales</span>
            </div>
            <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6">Nuestro staff</h1>
      ...
      <section className="py-12 md:py-24 bg-[#f5f7fa]">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto mb-12 md:mb-16">
            ...
            <h3 className="text-xl md:text-3xl font-bold text-[#00334e] mb-6 md:mb-8 text-center">
              Consejo de administración
            </h3>
              ...
              <Card className="overflow-hidden hover:shadow-2xl transition-all duration-300 group">
                <div className="relative h-40 md:h-64 bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                  <div className="w-20 h-20 md:w-32 md:h-32 bg-gradient-to-br from-[#0a4d5c] to-[#5dbfb3] rounded-full flex items-center justify-center">
                    <User className="text-white" size={32} className="md:w-12 md:h-12" />
                  </div>
                </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
              ...
              <Card className="overflow-hidden hover:shadow-2xl transition-all duration-300 group">
                ...
                <CardHeader className="text-center p-3 md:pb-4">
                  <CardTitle className="text-[#0a4d5c] text-[10px] md:text-base font-bold leading-tight">DR. JUAN MIGUEL BAYO</CardTitle>
                </CardHeader>
              </Card>
            </div>
          </div>
