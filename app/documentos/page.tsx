  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="py-8 bg-[#f5f7fa]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-white border-l-4 border-[#cfa46c] p-6 rounded-lg shadow-sm">
            <div className="flex items-start gap-4">
              <Info className="text-[#cfa46c] flex-shrink-0 mt-1" size={24} />
              <div>
            ...
            {documentCategories.map((category, index) => (
              <div key={index} className="max-w-5xl mx-auto">
                <div className="mb-6">
                  ...
                  <p className="text-[#333333]">{category.description}</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {category.documents.map((doc, idx) => (
                    <Card key={idx} className="border-2 border-[#cfa46c] hover:shadow-lg transition-shadow bg-white">
                      <CardHeader>
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex items-start gap-3 flex-1">
                            <div className="w-10 h-10 bg-[#cfa46c] rounded-lg flex items-center justify-center flex-shrink-0">
                          ...
                          <Button size="sm" className="bg-[#5bbaa5] hover:bg-[#4a9a85] flex-shrink-0">
                            <Download size={16} />
                          </Button>
                        </div>
                      </CardHeader>
      ...
      <section className="py-16 md:py-24 bg-[#f5f7fa]">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            <FileCheck className="w-16 h-16 text-[#5bbaa5] mx-auto mb-6" />
            <h2 className="text-3xl md:text-4xl font-bold text-[#00334e] mb-6">¿Necesitas ayuda con los documentos?</h2>
